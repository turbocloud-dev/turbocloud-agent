...
func createEnvLogsTableIfNeeded(environmentId string) {
	_, err := connection.WriteParameterized(
		[]gorqlite.ParameterizedStatement{
			{
				Query:     "CREATE TABLE " + "EnvLogs" + environmentId + " (Id TEXT NOT NULL PRIMARY KEY, Message TEXT, MachineId TEXT, EnvironmentId TEXT, DeploymentId TEXT, Level INTEGER, ImageId TEXT, CreatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL)",
				Arguments: []interface{}{},
			},
		},
	)
